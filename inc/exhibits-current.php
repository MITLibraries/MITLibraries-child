<?php
/**
 * The sub-template used by page-exhibits-home.php, page-exhibits-feed.php, category-rotch-library.php and category-maihaugen-gallery.php for displaying Current Exhibits.
 *
 * @package WordPress
