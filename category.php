<?php /** * The template for displaying Category pages. * * Used to display archive-type pages for posts in a category. * * Learn more: http://codex.wordpress.org/Template_Hierarchy * * @package MIT_Libraries_Child * @since Twenty Twelve 1.0 */ $pageRoot=g etRoot( $post ); $section=g et_post( $pageRoot ); $isRoot=$ section->ID == $post->ID; get_header(); get_template_part( 'inc/breadcrumbs', 'category' ); ?>
    ...
    <div id="content" class="content has-sidebar">
        <div class="main-content">
            <div class="entry-content">
                ...
                <?php if ( is_category() ) { echo '<h2>'; single_cat_title(); echo '</h2>'; } ?>
                <div id="sticky-posts-2" class="widget-1 widget-first widget-last widget-odd hide-title widget widget_ultimate_posts" role="complementary">
                    ...
                    <div class="upw-posts hfeed">
                        ...
                        <?php $current_post=( $post->ID == $current_post_id && is_single()) ? 'active' : ''; $custom_fields = get_fields($current_post_id); ?>
                        ...
                        <article <?php post_class( $current_post ); ?>>
                            ...
                            <div class="upw-content">
                                ...
                                <?php $custom_field_name=e xplode( ',', $custom_fields ); ?>
                                <div class="entry-custom-fields">
                                    <?php foreach ( $custom_field_name as $name ) : $name=t rim( $name ); $custom_field_values=g et_post_meta( $post->ID, $name, true ); if ( $custom_field_values ) : ?>
                        ...
                        <ul class="post-navigation">
                            ...
                            <li>
                                <?php next_posts_link( 'Older Posts', $custom_query->max_num_pages ) ?></li>
                        </ul>
